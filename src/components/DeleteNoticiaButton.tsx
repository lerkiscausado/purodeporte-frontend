...
import { deleteNoticia } from "@/app/actions/noticias";
        ...
        >
          ...
          <div className="p-6 space-y-4 text-left">
            <p className="text-sm text-muted-foreground">
              ¿Estás seguro de eliminar la noticia <span className="font-black text-foreground uppercase">{noticiaTitulo}</span>? Esta acción no se puede deshacer.
            </p>
