...
interface DeleteEquipoButtonProps {
  equipoId: number;
  equipoNombre: string;
}

export function DeleteEquipoButton({ equipoId, equipoNombre }: DeleteEquipoButtonProps) {
        ...
        >
          ...
          <div className="p-6 space-y-4">
            <p className="text-sm text-muted-foreground">
              ¿Estás seguro de eliminar al equipo <span className="font-black text-foreground uppercase">{equipoNombre}</span>? Esta acción no se puede deshacer.
            </p>
