...
import { EstadisticasPartidoManager } from "@/components/EstadisticasPartidoManager";
...
export function PartidoPeriodosClient({ torneo, partido }: PartidoPeriodosClientProps) {
  ...
  const _unusedEquipoIds = { localEquipoId, visitanteEquipoId };
  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto pb-12">
      ...
      <EstadisticasPartidoManager
        partido={partido}
        torneo={torneo}
        tiposEstadistica={tiposEstadistica}
        planillas={planillas}
        matchStats={matchStats}
        loadingStats={loadingStats}
        onStatsUpdated={(newStats) => setMatchStats(newStats)}
      />
