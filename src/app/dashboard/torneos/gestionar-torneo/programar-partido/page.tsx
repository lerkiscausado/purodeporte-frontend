...
export default async function ProgramarPartidoPage({ searchParams }: PageProps) {
  ...
  if (token) {
    try {
      ...
      console.error("Error al cargar torneo para programar partido:", error);
